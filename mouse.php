                             ...
                             $search_result = mysqli_query($konek, 'SELECT * FROM tb_mouse');
                               while($row = mysqli_fetch_array($search_result)) { ?>
                                  <tr>
                                   ...
                                   <a href="mouse_server.php?delMouse=<?php echo $row['mouse_id']; ?>" class="btn btn-danger lnr lnr-trash" onclick="return confirm('Are you sure you want to delete this mouse? Click cancel if not!')" rel="tab"></a>
                                    </td>
