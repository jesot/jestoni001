...
<body>
		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					<h4 class="page-title"><strong>SYSTEM UNIT</strong>/ Monitor</h4>
          <div class="col-md-12">  
            <div class="alert alert-success">
             <strong>Note:</strong> Please choose an available Computer or PC Name where you want to install specific monitor.
            </div>
            <div>
						...
						<div class="col-md-3">
							<div class="panel">
								<div class="panel-heading">
								 <center><h3 class="panel-title"><span class="fa fa-plus"></span><strong>  MONITOR</strong></h3></center>
								</div>
   ...
   <!--panel end-->           </div>
              ...
              <div class="panel">
                <div class="panel-heading">
                 <center><h3 class="panel-title"><span class="fa fa-list"></span><strong>    List of Monitor</strong></h3></center>
                </div>
